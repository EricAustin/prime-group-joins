...
SELECT warehouse.warehouse, products.description AS product FROM products 
...
SELECT products.description AS product , warehouse.warehouse FROM products 
JOIN warehouse_product ON products.id=warehouse_product.product_id
JOIN warehouse ON warehouse.id= warehouse_product.warehouse_id
...
SELECT customers.first_name, count(customers.first_name) as number_of_orders FROM orders 
...
SELECT products.description AS product_name, sum(warehouse_product.on_hand) AS total_on_hand FROM warehouse_product 
